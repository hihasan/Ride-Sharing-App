    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (etEmail.toString().equals("017") && etPassword.toString().equals("1234")){
                    Intent i=new Intent(SignInMain.this, MainActivity.class);
                    startActivity(i);
                }

                else {
                    Toast.makeText(getApplicationContext(),"Wrong user phone or password", Toast.LENGTH_SHORT).show();
...
//                url = new URL("http://bachaw.com/api_update/rider_login.inc.php");
//
