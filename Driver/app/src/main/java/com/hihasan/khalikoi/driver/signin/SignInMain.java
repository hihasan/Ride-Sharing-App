    ...
    private class AsyncLogin extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://bachaw.com/api/driver_login.inc.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("true"))
            {
                ...
                Toast.makeText(SignInMain.this, "Invalid email or password", Toast.LENGTH_LONG).show();

            } else if (result.equalsIgnoreCase("exception") || result.equalsIgnoreCase("unsuccessful")) {

                Toast.makeText(SignInMain.this, "OOPs! Something went wrong. Connection Problem.", Toast.LENGTH_LONG).show();
